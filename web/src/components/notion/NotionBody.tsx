...
const FIGURE_ARIA_LABELS: Record<string, string> = {
  ...
  "pedigree-drepanocytose": "Arbre généalogique de la famille étudiée : I-1 (homme sain) et I-2 (femme saine), tous deux A//a, ont deux enfants — II-1 (femme atteinte de drépanocytose), homozygote a//a, et II-2 (homme sain), dont le génotype reste incertain entre A//A et A//a à ce stade. Légende : carré = homme, cercle = femme, case pleine = atteint, case vide = sain, trait horizontal = union.",
