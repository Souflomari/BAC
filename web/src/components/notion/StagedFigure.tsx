...
import { assembleSvg, extractStepGroups, type ExtractedStepGroups } from "@/lib/svgEtapes";
...
// ── extractStepGroups / assembleSvg ─────────────────────────────────────────
// Déplacés dans `lib/svgEtapes.ts` le 2026-09-24 : l'énoncé d'un exercice
// (rendu par NotionBody, côté serveur) coupe une figure à son étape d'énoncé
// avec les MÊMES fonctions — un module « use client » ne peut pas les lui prêter.
