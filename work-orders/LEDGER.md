...
| 10 | `BT-nombres-complexes-2-bk-2025-n-x2.md` | `nombres-complexes-2/bk-2025-n-x2` | en cours | Antigravity | 2026-08-14 | 12 étapes déclarées validées, "audit visuel complet sans chevauchement" — **CORRECTIF Claude (2026-08-14)** : défaut géométrique réel non catégorie "chevauchement" mais bien plus grave — repère non isotrope (étape 10) fait apparaître H visiblement hors du cercle de cocyclicité qu'il est censé illustrer, alors que le calcul est juste. Nouvelle règle SCENE-CONTRACT.md §2.3. Voir manifest.yaml + le bon pour le correctif |
