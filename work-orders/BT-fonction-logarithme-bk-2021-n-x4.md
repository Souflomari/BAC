# BT — bk-2021-n-x4 · fonction-logarithme
...
## La tâche
Écrire `class Explication(BacScene)` dans **`animations/scenes/maths/fonction-logarithme/bk-2021-n-x4.py`**,
pour l'entrée **`bk-2021-n-x4`** de **`content/maths/fonction-logarithme/bank.yaml`**
(**lignes 541 à 783**, barème 9 points).
...
python -c "import importlib.util,sys; sys.path.insert(0,'animations'); \
  spec=importlib.util.spec_from_file_location('s','animations/scenes/maths/fonction-logarithme/bk-2021-n-x4.py'); \
  m=importlib.util.module_from_spec(spec); spec.loader.exec_module(m); print('OK')"

# 1 — lint de scène
python scripts/scene-lint.py animations/scenes/maths/fonction-logarithme/bk-2021-n-x4.py

# 2 — rendu brouillon (nb de sections == nb d'étapes)
cd animations && manim render scenes/maths/fonction-logarithme/bk-2021-n-x4.py Explication -ql \
  --media_dir media/maths-fonction-logarithme --save_sections && cd ..
ls animations/media/maths-fonction-logarithme/videos/bk-2021-n-x4/480p15/sections/*.mp4 | wc -l
...
python scripts/bank-fidelity.py content/maths/fonction-logarithme/bank.yaml bk-2021-n-x4 animations/scenes/maths/fonction-logarithme/bk-2021-n-x4.py

# 5 — rendu final, puis statut
cd animations && manim render scenes/maths/fonction-logarithme/bk-2021-n-x4.py Explication -qm \
  --media_dir media/maths-fonction-logarithme --save_sections && cd ..
