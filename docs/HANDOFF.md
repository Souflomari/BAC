...
### 11.45 La campagne de correction de contenu vague 1 — trente-quatre notions triées (MATHS BOUCLÉ ; PC 15/25), 438 correctifs objectifs, les bloquants consignés
...
**438 correctifs objectifs** au total, dont **106 pour la seule campagne de
...
**Sévérité mesurée** sur les 62 notions, après correctifs : forme A, 0 ;
forme B, 0. Le seul reste est une CITATION de la forme A dans un
