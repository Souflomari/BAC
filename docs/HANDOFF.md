...
### 11.45 La campagne de correction de contenu vague 1 — vingt-deux notions triées (MATHS BOUCLÉ), 199 correctifs objectifs, les bloquants consignés
...
**199 correctifs objectifs** au total (dont 14 classes sur `pc/systemes-oscillants`
et 11 sur `pc/chute-mouvements-plans`,
