...
### 11.45 La campagne de correction de contenu vague 1 — dix-neuf notions triées, 159 correctifs objectifs, les bloquants consignés
...
**159 correctifs objectifs** au total, 0 échec `validate-content --strict` sur les
dix-neuf. Les défauts **bloquants** ne sont jamais réécrits en autonomie — ils
