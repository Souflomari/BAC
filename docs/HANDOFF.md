...
### 11.45 La campagne de correction de contenu vague 1 — dix-huit notions triées, 149 correctifs objectifs, les bloquants consignés
...
**149 correctifs objectifs** au total, 0 échec `validate-content --strict` sur les
dix-huit. Les défauts **bloquants** ne sont jamais réécrits en autonomie — ils
