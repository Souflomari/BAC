...
course-422/upload-87465, page(s) 2. À faire vérifier (README §3).
...
$t\ (\text{h})$, gradué (traits principaux chiffrés) $40$ et $80$. Courbe
croissante et concave (allure de saturation), partant à $t = 0$ d'une valeur
non chiffrée légèrement au-dessus du repère $0{,}2$ *(lecture à confirmer)*,
montant rapidement puis s'incurvant vers un palier horizontal (trait
pointillé) à une valeur non chiffrée, au-dessus du repère $0{,}2$ *(lecture à
confirmer)*. La droite $(T)$ est tangente à la courbe au point marqué d'une
croix « $\times$ », situé entre les repères $40$ et $80$ (cohérent avec
l'abscisse donnée $t_1 = 60\ \text{h}$) ; au-delà de ce point de tangence, la
droite $(T)$ se prolonge en ligne droite vers le coin supérieur du cadre
tandis que la courbe continue de s'incurver vers son palier. Légende :
« Figure 1 ».
