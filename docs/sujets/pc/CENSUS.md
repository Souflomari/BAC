...
| 2011 | N | NS28 | `element/94445`/`94446`/`94447` · `upload-70313`/`70314`/`70315` (7 p.) | **décomposé** (2026-08-29) | PDF **hybride** Nitro Pro (figures bitmap 130–176 dpi, frère exact de 2011 R — même re-fabrication du 2020-03-09 à 26 s près). Chimie 7 · nucléaire 3 · élec 4,5 · méca 5,5 = 20, **27 questions**. **⚠️ Défaut de fond S1** : le plateau de la figure 1 de chimie (≈ 740 hPa mesuré) contredit les données imprimées (≈ 227 hPa attendus, facteur 3,26 ; courbe tracée avec x_max = nᵢ(H₃O⁺) = 0,03 mol) ; t½ reste résoluble (≈ 42 min). **Un corrigé non officiel arabophone existe HORS AlloSchool** (TelmidTice, MD5 consigné) : 27/27 valeurs concordantes — et il ne voit pas S1 |
...
| 2015 | R | RS 28 | `element/94476` · `course-422/upload-70343` (7 p.) ; jumeaux `94475`/`94477` | **décomposé** (2026-08-29) | SUJET ENTIER transcrit (`_incoming/pc-2015-r.md`, NON vérifié) : Ex1 chimie 7 (dosage 4 + phéromone 3) · Ex2 QCM 3 (ondes 1,5 + nucléaire 1,5) · Ex3 élec 4,5 (RL 2 + RLC 2,5) · Ex4 méca 5,5 (skieur 3 + torsion 2,5) = 20, **34 questions**. **Défaut du sujet : l'Ex4 imprime DEUX FOIS « Première partie »** (la seconde est la deuxième). **Corrigé non officiel trouvé** sur svt-assilah (t1887) — même famille que celui de 2011 N |
