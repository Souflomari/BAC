...
| `pc-2017-n.md` | 7 blocs : pile Al-Cu · acide butanoïque · estérification · QCM ondes · dipôle RL · skieur · pendule de torsion | 18,25 | **NON VÉRIFIÉ** — 4 contrôles + les 3 instruments ; PDF **natif** (pdfFactory), figures **vectorielles**, aucun caractère deviné. Les 3 exemplaires parallèles **byte-identiques**. **⚠️ RÉFUTE UNE VALEUR PUBLIÉE** : `bk-2017-n-x3` et le **sommet r-bac** portent $F_p = 2$ kHz, le scan donne **1 kHz** (3 preuves, dont le corrigé). **46 coquilles sur 25 types** ; une question **tronquée** ; le plan incliné dessiné à 9,24° pour α = 23° |
