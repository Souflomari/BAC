...
| `pc-2015-r.md` | **SUJET ENTIER** (2ᵉ intégrale) — dosage · phéromone · 2 QCM · RL · RLC · skieur · torsion | 20,00 | **NON VÉRIFIÉ** — 4 contrôles + 3 instruments, 34 questions, barème par deux chemins concordants. **Défaut du sujet : « Première partie » imprimé deux fois** dans l'Ex4. **Corrigé non officiel trouvé** (svt-assilah t1887, même famille que 2011 N). *Le fichier a survécu à un kill de plafond ; son intégrité a été contrôlée section par section avant commit* |
| `pc-2011-n.md` | **SUJET ENTIER** (première intégrale : zéro entrée préexistante) — chimie · nucléaire · électricité · mécanique | 20,00 | **NON VÉRIFIÉ** — 4 contrôles + 3 instruments ; PDF **hybride** (figures 130–176 dpi, plafonds chiffrés). **Défaut de fond S1** : le plateau de la figure de chimie contredit les données d'un facteur 3,26, mécanisme identifié. **Corrigé trouvé HORS AlloSchool** (TelmidTice, non officiel) : 27/27 concordances — cible externe pour la vérification, que 2011 R n'avait pas |
