...
## R0 — Accroche : le puzzle qui ne peut pas être un hasard

Regarde une carte du monde et isole seulement deux morceaux : la côte est de l'Amérique du Sud, et la côte ouest de l'Afrique. Le renflement brésilien se glisse presque exactement dans le golfe de Guinée. Ce n'est pas vague : les grandes baies, les caps, les avancées correspondent, comme les pièces découpées d'un même puzzle qu'on aurait écarté.

Ajoute un deuxième fait, en apparence sans rapport. Dans des couches de roches vieilles de plus de 250 millions d'années, on trouve, à la fois sur la côte brésilienne et sur la côte sud-africaine, les fossiles d'un seul et même animal : un petit reptile aquatique du nom de *Mesosaurus*, qui vivait exclusivement en eau douce, dans des lacs et des rivières. Il n'avait ni les moyens ni la morphologie pour traverser un océan de plusieurs milliers de kilomètres.
...
## R1 — La dérive des continents : l'idée de Wegener et ses arguments

### Ce que Wegener propose

Wegener avance une hypothèse simple à énoncer, radicale pour son époque : tous les continents actuels auraient été assemblés, il y a environ 250 millions d'années, en une seule masse continentale unique, qu'on appelle aujourd'hui la **Pangée**. Cette masse se serait ensuite fragmentée, et les morceaux — nos continents actuels — se seraient lentement écartés les uns des autres jusqu'à leurs positions d'aujourd'hui. C'est ce qu'on appelle la **dérive des continents**.

Une hypothèse audacieuse ne suffit pas : Wegener l'appuie sur quatre familles d'arguments indépendants, chacun construit comme un raisonnement, pas comme une simple observation isolée.
...
### Argument 3 : l'argument géologique

Certaines chaînes de montagnes, ou certaines formations rocheuses précises (même type de roche, même âge, même structure interne), s'arrêtent brutalement à la côte d'un continent — et reprennent, avec les mêmes caractéristiques, sur la côte du continent d'en face, de l'autre côté de l'océan. C'est le cas, par exemple, entre certaines formations plissées d'Afrique australe et d'Argentine.

Le raisonnement : une structure géologique continue ne se forme pas en deux morceaux séparés par un océan qui n'a rien à voir avec elle. Si la même chaîne, avec la même histoire géologique, se retrouve de part et d'autre d'un océan, la lecture la plus cohérente est que la chaîne s'est formée d'un seul tenant, avant que l'océan ne vienne, plus tard, la couper en deux.

### Argument 4 : l'argument paléoclimatique

Dans des roches vieilles d'environ 300 millions d'années, on trouve, en Amérique du Sud, en Afrique australe, en Inde et en Australie, des traces caractéristiques d'un climat glaciaire ancien (stries laissées par des glaciers, dépôts typiques d'une calotte de glace) — alors que ces régions sont aujourd'hui tropicales ou tempérées, bien trop chaudes pour qu'un glacier s'y forme. À l'inverse, on trouve en Antarctique des fossiles de forêts tropicales luxuriantes, incompatibles avec le climat polaire actuel du continent.
...
Beaucoup répondent spontanément que les preuves ont dû être invalidées — après tout, une idée rejetée doit bien avoir été réfutée. C'est une supposition raisonnable. Elle est fausse.
...
### Le calcul qui a tué l'hypothèse — provisoirement

Des physiciens, en particulier le géophysicien britannique Harold Jeffreys, ont fait le calcul : ces forces, mises bout à bout, sont des millions de fois trop faibles pour faire bouger des masses continentales entières à travers un plancher océanique que l'on savait déjà, à l'époque, être une roche rigide et solide. Un continent n'est pas un bateau qui glisse sur l'eau ; c'est une masse de roche rigide posée sur une autre masse de roche rigide, et rien dans les forces connues ne pouvait produire assez de poussée pour la faire avancer de plusieurs milliers de kilomètres.
...
## R3 — L'expansion océanique : le plancher qui se renouvelle

L'hypothèse de Wegener reste en sommeil pendant près de cinquante ans. Ce qui va la relancer n'est pas une nouvelle observation sur les continents, mais des technologies nées de la Seconde Guerre mondiale — sonar, magnétomètres embarqués sur des navires — utilisées, dans les années 1950 et 1960, pour cartographier systématiquement le fond des océans pour la première fois de l'histoire.

### Une découverte inattendue : les dorsales

Ces campagnes révèlent l'existence d'une immense chaîne de montagnes sous-marine, longue de plus de 60 000 kilomètres, qui serpente au milieu de tous les grands océans — la **dorsale océanique**. Personne ne s'attendait à trouver, au milieu de l'océan Atlantique par exemple, un relief montagneux continu de cette ampleur.
...
### Preuve 1 : la symétrie des anomalies magnétiques

Le champ magnétique terrestre n'est pas constant dans le temps : à intervalles irréguliers, de quelques dizaines de milliers à quelques millions d'années, il **s'inverse** complètement — le pôle nord magnétique devient le pôle sud, et inversement. C'est un phénomène lent, enregistré dans l'histoire géologique.

Or, quand la roche volcanique (le basalte) se forme au niveau de la dorsale et se refroidit, les minéraux magnétiques qu'elle contient s'orientent selon le champ magnétique terrestre du moment — puis se figent définitivement dans cette orientation, comme une boussole gelée à l'instant de la solidification. Chaque nouvelle portion de plancher océanique enregistre donc, de façon permanente, l'orientation du champ magnétique au moment exact de sa formation.

Quand on mesure le magnétisme du plancher océanique de part et d'autre d'une dorsale, on trouve une succession de bandes, alternant une orientation puis l'autre — et ces bandes forment un motif **rigoureusement symétrique** par rapport à l'axe de la dorsale : la même séquence de bandes se retrouve, dans le même ordre, aussi bien à l'est qu'à l'ouest de la dorsale.

Voici pourquoi cette symétrie est une preuve, et pas une simple curiosité : si le plancher se forme en continu exactement à l'axe de la dorsale, et s'écarte ensuite également des deux côtés à la même vitesse, alors les deux flancs doivent enregistrer exactement la même histoire des inversions magnétiques, chacun de son côté, à la même distance de l'axe pour un même âge. C'est précisément le motif observé. Un plancher océanique fixe, ou un plancher qui ne se formerait pas à la dorsale, ne produirait aucune raison pour qu'un tel miroir parfait existe.

### Preuve 2 : l'âge croissant des sédiments avec l'éloignement de la dorsale

Une deuxième ligne de preuve, indépendante de la première, vient des sédiments qui s'accumulent lentement au-dessus de la roche volcanique du plancher océanique. Des forages effectués dans le cadre de programmes de recherche océanographique montrent deux choses, systématiquement, sur tous les océans étudiés :

- L'épaisseur des sédiments accumulés augmente à mesure qu'on s'éloigne de l'axe de la dorsale.
- L'âge de la roche volcanique directement sous ces sédiments (daté par des méthodes radiométriques) augmente lui aussi, régulièrement, avec la distance à la dorsale — quasiment nul à l'axe, et de plus en plus ancien à mesure qu'on s'en éloigne, jusqu'à atteindre plusieurs dizaines, voire plus de cent millions d'années près de certaines marges continentales.

Le raisonnement est direct : si le plancher se forme en continu à l'axe de la dorsale, alors la roche la plus proche de l'axe est la plus récente (elle vient tout juste de se solidifier, elle n'a pas encore eu le temps d'accumuler beaucoup de sédiments) — tandis que la roche la plus éloignée s'est formée il y a très longtemps, et a eu tout ce temps pour accumuler une épaisse couche de sédiments par-dessus. Cet accroissement régulier de l'âge avec la distance est exactement la signature attendue d'un plancher qui naît à un endroit précis et s'écarte ensuite dans les deux sens.

### Ce que ces deux preuves établissent ensemble

La symétrie des anomalies magnétiques et le gradient d'âge des sédiments sont deux observations complètement indépendantes — l'une vient du magnétisme des roches, l'autre de la datation et de l'épaisseur des sédiments — et pourtant elles racontent exactement la même histoire : le plancher océanique n'est pas une surface fixe et ancienne. Il se crée en continu à l'axe des dorsales, et s'écarte ensuite, comme deux tapis roulants opposés partant du même point.
...
Avant d'aller plus loin, il faut préciser une distinction essentielle, qu'on confond souvent — et qui change tout dans la façon de comprendre ce qui bouge réellement.

### Une distinction de composition : la croûte

La **croûte** est définie par sa composition chimique. On distingue la croûte continentale (roches comme le granite, plutôt épaisse, entre 30 et 70 kilomètres) et la croûte océanique (roches comme le basalte, beaucoup plus fine, 5 à 10 kilomètres). C'est la couche la plus superficielle du globe.

### Une distinction de comportement mécanique : la lithosphère et l'asthénosphère

Mais la question qui nous intéresse ici — qu'est-ce qui bouge comme un bloc rigide, et qu'est-ce qui se déforme lentement — n'est pas une question de composition chimique. C'est une question de **comportement mécanique**, qui dépend surtout de la température de la roche.

La partie la plus superficielle du globe — la croûte tout entière, PLUS la partie la plus haute du manteau sous-jacent, suffisamment froide pour se comporter comme un solide rigide et cassant — forme un ensemble qu'on appelle la **lithosphère**. C'est elle qui se fracture, qui se plie, qui se casse le long de failles — bref, qui se comporte comme une coquille rigide à l'échelle géologique.

Sous la lithosphère se trouve l'**asthénosphère** : chimiquement, c'est la même roche mantellique — mais elle est nettement plus chaude, si proche de son point de fusion qu'elle devient **ductile** : elle peut se déformer et s'écouler très lentement, sur des millions d'années, un peu comme du verre chaud ou une glace très épaisse peut lentement fluer sous son propre poids. Attention : ductile ne veut pas dire liquide. L'asthénosphère reste une roche solide — elle flue extrêmement lentement, elle ne fond pas et ne coule pas comme de la lave ou de l'eau.
...
## R5 — Les plaques lithosphériques et leurs frontières
...
À l'inverse, deux plaques peuvent converger l'une vers l'autre. Que se passe-t-il alors dépend de ce que chaque plaque porte à sa surface. Une plaque de lithosphère océanique, en s'éloignant de la dorsale où elle est née, se refroidit progressivement — et une roche qui refroidit devient plus dense. Après plusieurs dizaines de millions d'années, cette lithosphère océanique refroidie devient plus dense que l'asthénosphère sur laquelle elle repose : quand elle rencontre une autre plaque, elle plonge sous celle-ci et s'enfonce dans le manteau, où elle est progressivement réabsorbée. On appelle ce processus la **subduction**.

Le raisonnement mécanique est simple : c'est la densité, acquise avec l'âge par refroidissement, qui condamne la plaque océanique à plonger — pas une force extérieure qui la pousserait vers le bas. C'est ce qui se produit, par exemple, le long de la fosse du Pérou-Chili (la plaque océanique de Nazca plonge sous la plaque sud-américaine) ou au large du Japon (la plaque pacifique plonge sous la plaque eurasiatique). Ces zones de subduction sont marquées par de profondes fosses océaniques et, un peu plus loin sur la plaque supérieure, par des chaînes de volcans actifs.
...
### Coulissage : les failles transformantes
...
|---|---|---|---|---|
| Divergente (dorsale) | Écartement | Création de lithosphère océanique | Dorsale médio-atlantique | Volcanisme, sismicité modérée |
| Convergente — subduction | Rapprochement, une plaque plonge | Destruction (réabsorption dans le manteau) | Fosse Pérou-Chili, Japon | Fosse océanique, volcanisme, forte sismicité |
...
### Exercice travaillé : lire un profil d'âge du plancher océanique

**Énoncé.** Une campagne océanographique traverse perpendiculairement la dorsale médio-atlantique et prélève des échantillons de basalte du plancher océanique à différentes distances de l'axe de la dorsale, de part et d'autre. La datation radiométrique de ces échantillons donne les résultats suivants :

- À l'axe de la dorsale (distance 0 km) : âge quasi nul.
...
3. Cette vitesse te semble-t-elle cohérente avec ce qu'on attend d'une dorsale océanique (quelques centimètres par an) ?
4. En quoi ce profil constitue-t-il une preuve de l'expansion océanique, et non d'un simple dépôt de sédiments plus rapide près de la dorsale ?

**Raisonnement.**

Ce qu'on cherche ici : reconnaître, dans un jeu de données concret, la signature attendue de l'expansion océanique — et être capable de justifier pourquoi cette signature exclut d'autres explications possibles, pas seulement de la reconnaître par automatisme.

**1. La symétrie.** Les âges sont rigoureusement identiques à distance égale de part et d'autre de l'axe (5 Ma à 50 km des deux côtés, 15 Ma à 150 km des deux côtés, 30 Ma à 300 km des deux côtés). C'est exactement le motif attendu si le plancher se forme au niveau de l'axe et s'écarte ensuite également dans les deux directions à la même vitesse.

**2. La vitesse.** Sur le flanc ouest, on parcourt 300 km en 30 millions d'années. La vitesse est donc de 300 km divisée par 30 millions d'années, soit 10 km par million d'années. En convertissant : 10 km, c'est 10 000 000 cm ; un million d'années, c'est 1 000 000 d'années. La vitesse est donc de 10 000 000 cm / 1 000 000 ans = 10 cm par an, sur ce seul flanc.

**3. Cohérence.** Cette valeur (10 cm/an sur un flanc) correspond à un flanc qui s'écarte relativement vite, mais reste du même ordre de grandeur que les vitesses d'expansion océanique mesurées ailleurs dans le monde (de 1 à plus de 15 cm par an selon les dorsales) — c'est plausible. Ce qui compte surtout pour reconnaître la cohérence de l'ensemble, c'est que cette vitesse est bien du même ordre de grandeur que les vitesses mesurées directement par GPS sur des dorsales actives (R6) : deux méthodes indépendantes — l'une basée sur l'âge des roches, l'autre sur une mesure satellite en temps réel — s'accordent.
