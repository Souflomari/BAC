# Les chaînes de montagnes et la tectonique

---

## R0 — Accroche : des fossiles marins au sommet du monde

Au sommet de l'Everest, à 8 849 mètres d'altitude, le point le plus haut de tous les continents, la roche qui forme le dernier bloc rocheux avant le ciel est un calcaire. Et ce calcaire contient des fossiles : des débris de crinoïdes, des petits animaux marins à tige articulée qui vivaient fixés au fond d'une mer, il y a plusieurs centaines de millions d'années. Pas près du sommet. Au sommet.

Ce n'est pas un cas isolé. Dans les Alpes, dans l'Himalaya, on trouve, coincés au milieu des roches de montagne, des blocs de roche sombre et dense — qu'on identifie, une fois analysés, comme des roches typiques du plancher océanique : là où on s'attendrait à ne trouver que du granite ou des sédiments de continent.
...
**Comment reconnaît-on, dans les roches d'aujourd'hui, la trace d'un océan qui a complètement disparu ?**

On ne répond pas tout de suite. On construit la réponse, preuve après preuve.

---

## R1 — La chaîne de subduction : quand l'océan plonge (les Andes)

Tu connais déjà le mécanisme de la subduction : une plaque de lithosphère océanique, refroidie et alourdie en s'éloignant de la dorsale où elle est née, devient plus dense que l'asthénosphère et plonge sous la plaque voisine quand les deux convergent. C'est ce mécanisme, appliqué le long de la bordure ouest de l'Amérique du Sud, qui construit la cordillère des Andes.

### Ce qui se voit en surface

Là où la plaque océanique de Nazca plonge sous la plaque sud-américaine, deux reliefs se forment, décalés l'un de l'autre :

- Juste à l'endroit où la plaque plonge, une **fosse océanique** profonde — la trace du pli vers le bas de la plaque qui s'enfonce.
- Plus loin, du côté continental, à quelques centaines de kilomètres de la fosse, une **chaîne de volcans actifs**, alignés parallèlement à la fosse : c'est la cordillère elle-même.

Ces deux reliefs ne sont pas des coïncidences géographiques : ils sont la conséquence directe et mécanique de la plongée de la plaque.

### Pourquoi un volcanisme, et pourquoi justement là

Voici la question à se poser : pourquoi la subduction produit-elle des volcans, et pourquoi ces volcans apparaissent-ils à distance de la fosse, et pas juste au-dessus du point de plongée ?

La plaque océanique qui s'enfonce n'est pas de la roche sèche : elle porte, piégée dans ses minéraux depuis sa formation à la dorsale, de l'eau. En s'enfonçant et en se réchauffant progressivement avec la profondeur, la plaque relâche cette eau, qui migre vers le haut, dans le coin de manteau situé juste au-dessus d'elle. Or l'eau a un effet précis sur la roche du manteau : elle abaisse la température à laquelle cette roche commence à fondre — exactement comme le sel abaisse la température de fusion de la glace. Le manteau au-dessus de la plaque, sans être devenu plus chaud, franchit alors son seuil de fusion, appauvri par l'eau : il fond partiellement. C'est cette **fusion partielle**, déclenchée par l'eau relâchée par la plaque et non par un excès de chaleur, qui produit le magma. Ce magma remonte, traverse l'épaisse croûte continentale sud-américaine, et se met en place en surface sous forme de volcans — décalés vers l'intérieur du continent, parce que c'est là, à une certaine profondeur sur son trajet, que la plaque relâche assez d'eau pour déclencher la fusion, pas juste sous la fosse où elle vient à peine d'entamer sa plongée.

En traversant la croûte continentale, ce magma se modifie chimiquement au contact des roches continentales qu'il traverse : il en ressort avec une composition intermédiaire, ni aussi pauvre en silice que la lave des dorsales, ni aussi riche que le granite continental. On appelle cette roche l'**andésite**, et c'est pour ça qu'on parle de **volcanisme andésitique** dans les Andes — un nom qui vient d'ailleurs de cette cordillère elle-même.

### Pourquoi les séismes s'enfoncent avec la distance à la fosse

Deuxième signature de la subduction, en plus du volcanisme : la profondeur des foyers sismiques. Si tu places sur une carte tous les séismes enregistrés le long d'une coupe perpendiculaire à la cordillère des Andes, tu observes que les foyers les plus superficiels se trouvent près de la fosse, et que la profondeur des foyers augmente régulièrement à mesure qu'on s'éloigne vers l'intérieur du continent — jusqu'à plusieurs centaines de kilomètres de profondeur.

Le raisonnement est direct : ces séismes ne sont pas dispersés au hasard, ils dessinent un plan incliné qui suit exactement la trajectoire de la plaque plongeante. Tant que la plaque reste une masse rigide en train de s'enfoncer dans un manteau qui lui résiste, elle continue à produire des séismes le long de son trajet — et ce plan de séismes profonds est, à lui seul, la preuve qu'une plaque rigide est encore réellement en train de plonger là, aujourd'hui, à cet endroit précis.
...
### Ce qui se passe quand l'océan a totalement disparu

Après des dizaines de millions d'années de subduction, toute la lithosphère océanique de la Téthys a fini par être engloutie. Il ne reste alors, face à face, que la marge continentale de l'Inde et la marge continentale de l'Asie — et elles finissent par entrer en contact direct.

C'est là que tout change. La croûte continentale (granite, roche relativement légère) est bien trop peu dense pour s'enfoncer dans le manteau, contrairement à la lithosphère océanique refroidie qui, elle, y parvient. Aucune des deux plaques ne peut donc plonger sous l'autre. La subduction, qui fonctionnait parfaitement tant qu'il restait de l'océan à engloutir, s'arrête net dès que les deux blocs en présence sont continentaux des deux côtés.
...
La prédiction « l'Himalaya doit ressembler aux Andes » se trompait précisément parce qu'elle traitait toute convergence de plaques comme identique. Ce n'est pas le cas : ce qui distingue une chaîne de subduction d'une chaîne de collision, ce n'est pas qu'il y ait ou non convergence — il y en a dans les deux cas — c'est ce que chaque plaque porte à sa surface, et donc ce que la convergence peut encore faire disparaître en profondeur.

| | Chaîne de subduction (Andes) | Chaîne de collision (Himalaya) |
|---|---|---|
| Plaques en présence | Océanique plongeant sous continentale | Continentale contre continentale |
| Devenir de la lithosphère | Destruction en profondeur (subduction active) | Aucune plaque ne peut plonger |
| Volcanisme | Actif, de composition andésitique | Absent |
...
Voici un problème. Si l'océan qui séparait l'Inde de l'Asie a été **entièrement** englouti par subduction, comment peut-on encore savoir, aujourd'hui, qu'il a vraiment existé ? On ne peut plus observer cet océan : il n'est plus là. Il faut trouver, dans les roches de l'Himalaya lui-même, une trace matérielle de son ancienne présence.

### Un morceau de plancher océanique qui a échappé à la subduction

Dans les tout derniers instants avant la fermeture complète de l'océan, la subduction n'engloutit pas toujours la totalité de la lithosphère océanique de façon parfaitement propre. Il arrive qu'un fragment de cette lithosphère océanique — au lieu de plonger jusqu'au bout dans le manteau — se détache, reste coincé entre les deux marges continentales qui se rapprochent, et se retrouve chevauché, soulevé, écrasé au sein même de la chaîne en formation, plutôt qu'avalé. On appelle ce fragment préservé une **ophiolite**.

### Comment reconnaître une ophiolite : sa composition trahit son origine

Ce qui rend une ophiolite identifiable sans ambiguïté, ce n'est pas seulement sa position au milieu d'une chaîne de montagnes continentale — c'est sa composition, qui reproduit, couche par couche, la structure exacte de la lithosphère océanique :

- Au sommet, des **basaltes en coussins** (des coulées de lave solidifiées, reconnaissables à leur forme arrondie caractéristique, qui ne se forme que lorsque la lave refroidit brutalement au contact de l'eau) — la preuve, à elle seule, d'une mise en place sous-marine.
- En dessous, du **gabbro**, le même magma que le basalte, mais refroidi lentement en profondeur, sous la croûte océanique.
- Encore en dessous, de la **péridotite**, une roche mantellique dense, plus riche en fer et en magnésium — le sommet du manteau tel qu'il existait sous cet ancien plancher océanique.

Cette séquence précise — basalte en coussins, puis gabbro, puis péridotite — est la signature de la croûte océanique et du manteau supérieur qui la porte. Elle n'a rien à voir avec la composition de la croûte continentale environnante, faite essentiellement de granite : une roche claire, riche en silice, en quartz et en feldspath, bien moins dense que la séquence océanique.
...
Les ophiolites prouvent qu'un océan a existé. Mais elles ne disent, à elles seules, rien sur ce qui est arrivé à la croûte continentale elle-même pendant la collision. Pour ça, il faut regarder comment les couches de roche sont déformées.

### Les plis : la roche qui se courbe plutôt que de casser

Des couches de roche sédimentaire, déposées à l'origine à plat (empilées horizontalement au fond d'une mer ou sur une marge continentale), se retrouvent, dans une chaîne de collision, courbées en vagues successives — des **plis**. En profondeur, sous la pression et la température qui augmentent avec l'enfouissement, la roche perd sa rigidité de surface et se comporte, sur des millions d'années, presque comme un matériau souple : poussée par les deux bouts, elle se courbe plutôt que de se briser net.

### Les failles inverses et les chevauchements : quand la roche casse quand même

Plus près de la surface, où la roche reste cassante, la compression ne peut plus se résorber par un simple plissement : la roche se fracture le long d'un plan incliné, et un bloc entier est poussé vers le haut et par-dessus le bloc voisin. C'est une **faille inverse** ; quand le déplacement est de grande ampleur et le plan de faille presque horizontal, on parle de **chevauchement**.

Voici pourquoi cette structure est une preuve à elle seule, indépendamment des plis : un chevauchement peut placer une couche de roche **plus ancienne au-dessus** d'une couche **plus jeune** — alors que si les couches avaient simplement été déposées l'une après l'autre, sans dérangement, la plus ancienne serait forcément en dessous, jamais au-dessus. Trouver cet ordre inversé n'est pas un hasard de la sédimentation : c'est la trace directe qu'un bloc de croûte a été physiquement charrié par-dessus un autre, sous l'effet d'une compression suffisamment forte pour vaincre la résistance de la roche.

### Ce que plis et chevauchements ont en commun : ils racontent le raccourcissement
...
Troisième indice, indépendant des deux premiers. Certaines roches qu'on trouve exposées, aujourd'hui, à la surface d'une chaîne de collision, montrent une structure minérale qui ne peut se former qu'à de grandes profondeurs, sous des pressions et des températures que la surface ne connaît jamais.
...
### Exercice travaillé : interpréter une coupe de terrain

**Énoncé.** Un géologue étudie une coupe de terrain traversant une chaîne de montagnes, sur plusieurs dizaines de kilomètres. Il rapporte les observations suivantes :

- En un point de la coupe, un massif rocheux montre, de haut en bas, des basaltes en coussins, puis du gabbro, puis de la péridotite — l'ensemble coincé entre deux blocs de roche granitique bien identifiés comme continentaux.
- Ailleurs sur la coupe, des couches de calcaire sont plissées en vagues serrées, et une couche de calcaire plus ancienne repose directement au-dessus d'une couche de grès plus jeune, le long d'un plan de fracture incliné.
- Un troisième point de la coupe montre un gneiss (roche métamorphique) dont l'assemblage minéral indique une formation à environ 30 kilomètres de profondeur ; ce gneiss est aujourd'hui exposé à 4 000 mètres d'altitude.
- Sur l'ensemble de la coupe, aucun volcan actif n'est recensé, et tous les séismes enregistrés ont des foyers situés à moins de 40 kilomètres de profondeur.

1. À quel type de chaîne de montagnes appartient cette coupe ? Justifie ta réponse à partir de chacune des quatre observations.
2. Comment nommes-tu la structure rocheuse décrite au premier point, et pourquoi ne peut-elle pas s'agir d'une variété de croûte continentale ?
3. Que déduis-tu de la position relative du calcaire et du grès au deuxième point ?
4. Comment expliques-tu que le gneiss du troisième point, formé à 30 kilomètres de profondeur, soit aujourd'hui visible à 4 000 mètres d'altitude ?
5. Explique pourquoi l'absence de volcanisme et l'absence de séismes profonds sont, elles aussi, des arguments en faveur de ta réponse à la question 1.
...
**3. Le calcaire au-dessus du grès.** Une couche plus ancienne (le calcaire) reposant au-dessus d'une couche plus jeune (le grès), le long d'un plan de fracture incliné, ne peut pas résulter d'un simple dépôt sédimentaire — un dépôt normal placerait toujours le plus ancien en dessous. Cet ordre inversé signale un chevauchement : un bloc de croûte a été poussé et empilé par-dessus un autre, sous l'effet d'une compression horizontale — la signature directe d'un raccourcissement de la croûte.
...
**Prompt 1.** Une autre coupe de terrain montre une fosse océanique profonde, une chaîne de volcans actifs alignés à environ 200 kilomètres de la fosse, côté continental, et des foyers sismiques dont la profondeur augmente régulièrement, de quelques kilomètres près de la fosse jusqu'à plus de 300 kilomètres sous l'intérieur du continent. De quel type de chaîne s'agit-il ? Justifie à partir du mécanisme physique en jeu. Et à ton avis, est-il probable de trouver, le long de cette coupe, de larges affleurements d'ophiolites bien préservées, comparables à celles de l'Himalaya ? Explique pourquoi, en te rappelant ce qu'une ophiolite suppose sur le devenir de la lithosphère océanique.

**Prompt 2.** Sur une troisième coupe, on trouve des roches métamorphiques indiquant un enfouissement à 25 kilomètres de profondeur, aujourd'hui exposées en surface. Un élève conclut aussitôt : « c'est forcément une chaîne de collision. » Cette seule observation suffit-elle à l'affirmer avec certitude, ou pourrait-elle, à elle seule, avoir une autre explication ? Quels autres indices, parmi ceux vus dans cette leçon, chercherais-tu sur le terrain avant de conclure définitivement à une collision ?
