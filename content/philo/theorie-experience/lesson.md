...
Voici une situation que tu as sans doute déjà vécue, ou vue vécue dans ta famille. Prends le temps d'y réfléchir avant de lire la suite.

---

Ta grand-mère a un remède contre le rhume : une tisane de son invention, préparée toujours de la même façon. Depuis quarante ans, à chaque fois qu'elle a eu un rhume, elle a bu sa tisane — et à chaque fois, en quelques jours, elle est allée mieux. Elle en est absolument certaine : « Ça marche. Je l'ai vu, encore et encore, pendant quarante ans. Aucune exception. »

**À ton avis : quarante années d'expérience répétée, sans la moindre exception, suffisent-elles à prouver que la tisane guérit le rhume ?**
...
Mais si tu prends la seconde réponse au sérieux, une autre question surgit aussitôt : faut-il alors jeter l'expérience de grand-mère comme totalement sans valeur, et ne faire confiance qu'à des chiffres, des laboratoires, des raisonnements a priori, sans jamais rien observer ni tester ? Ce n'est pas non plus tenable : une théorie qu'on ne confronterait jamais à aucune expérience, aussi rigoureuse soit-elle sur le papier, resterait une pure spéculation, sans le moindre moyen de savoir si elle décrit quoi que ce soit du monde réel.

C'est exactement cette tension — la connaissance vient-elle de l'expérience seule, de la raison seule, ou de leur articulation ? Et l'expérience, la simple observation, peut-elle jamais être neutre, ou est-elle toujours déjà orientée par une idée, une attente, une théorie ? — que cette leçon va construire, pièce par pièce. On reviendra à cette tisane à la fin, et on retrouvera au passage plusieurs outils déjà construits dans la leçon sur la vérité (Bachelard, Popper) : cette leçon-ci les prolonge et les referme, elle ne repart pas de zéro.
...
**Le geste central de Hume :** toutes nos idées, même les plus abstraites, se laissent décomposer en éléments plus simples, et ces éléments simples se ramènent toujours, en dernière analyse, à des **impressions** — des perceptions sensibles immédiates, une couleur vue, une douleur sentie, un son entendu. Une idée n'est jamais, pour Hume, qu'une copie affaiblie d'une impression passée, ou une combinaison d'idées elles-mêmes issues d'impressions : même l'idée la plus étrange qu'on puisse former — une montagne d'or, par exemple — n'est qu'un assemblage de deux idées parfaitement ordinaires (montagne, or), chacune tirée d'impressions déjà vécues séparément. Il n'existe, pour Hume, aucune idée authentiquement innée, présente dans l'esprit indépendamment de toute expérience sensible antérieure.
...
R1 a présenté Hume comme celui pour qui toute connaissance vient de l'expérience. Mais Hume est aussi, et peut-être surtout, celui qui a montré la limite la plus embarrassante de ce projet : comment passe-t-on, légitimement, d'observations particulières et passées à une loi générale, valable pour tous les cas, y compris ceux qu'on n'a jamais observés ?

#### Le raisonnement inductif, et le problème qu'il cache

Raisonner par **induction**, c'est partir d'un ensemble d'observations particulières pour conclure à une loi générale : j'ai vu mille cygnes, tous blancs, donc je conclus que tous les cygnes sont blancs. Tu as déjà croisé cet exemple précis dans la leçon sur la vérité (la-verite, R7), à propos du critère de Popper ; reprenons-le ici pour en examiner la racine, chez Hume, avant même Popper.

**Le point que Hume établit, avec une rigueur qu'aucun exemple n'épuise :** aucun nombre d'observations passées, aussi grand soit-il, ne peut *logiquement* garantir une conclusion universelle valable pour tous les cas, y compris ceux qu'on n'observera jamais. Voir mille cygnes blancs ne rend pas logiquement impossible qu'il existe, quelque part, un cygne d'une autre couleur — ce qui s'est effectivement révélé exact : des cygnes noirs (*Cygnus atratus*) existent bel et bien en Australie, découverts par des explorateurs européens qui tenaient jusque-là « tous les cygnes sont blancs » pour une certitude acquise par l'expérience.

**Pourquoi ce n'est pas seulement « on a eu de la malchance », mais une faille logique plus profonde.** Le raisonnement inductif suppose, sans jamais pouvoir le prouver lui-même, que **la nature est régulière** — que ce qui s'est produit dans les cas observés se reproduira dans les cas non observés, que l'avenir ressemblera au passé. Or par quel raisonnement établirait-on ce principe de régularité ? Pas par la seule raison : rien, dans la simple logique, n'interdit que la nature change de comportement demain. Et pas non plus par l'expérience : en invoquer l'expérience passée pour justifier qu'elle continuera à valoir dans le futur, ce serait déjà supposer, pour le prouver, la conclusion même qu'on cherche à établir — un raisonnement qui tourne en rond. Hume en conclut que notre confiance dans l'induction n'est jamais une certitude rationnellement fondée, mais une habitude, une coutume de l'esprit, formée par la répétition — utile pour agir dans la vie courante, mais qui ne constitue jamais une preuve démonstrative.

**Un prolongement du même geste : la cause elle-même n'est jamais observée.** Hume pousse l'exigence plus loin encore, à propos de la causalité. Quand une boule de billard en heurte une seconde qui se met alors en mouvement, ce que les sens perçoivent réellement, c'est une succession — le contact, puis le mouvement — et une répétition de cette succession dans des cas semblables. Mais le lien de nécessité lui-même, ce qui ferait que la seconde boule *devait* nécessairement se mettre en mouvement, n'est perçu par aucun sens : on ne voit jamais la nécessité, seulement une **conjonction constante** entre deux événements. C'est très exactement l'erreur que commet, sans le voir, la conviction de grand-mère (R0) : elle a observé une conjonction constante — tisane, puis guérison — mais elle n'a jamais observé, et ne pouvait pas observer par les seuls sens, le lien de nécessité qui ferait de la tisane la cause de la guérison plutôt qu'un simple événement antérieur, sans rapport causal réel.
...
**Voici la thèse la plus importante de Bernard, celle qui change directement la façon de comprendre R2.** Une expérience scientifique n'est jamais un simple enregistrement neutre de ce qui se passe : elle part toujours d'une **idée préconçue** — une hypothèse, une question précise — qui décide à l'avance ce qu'il faut observer, comment il faut le mesurer, et quel résultat compterait comme un succès ou comme un échec de l'hypothèse. Sans cette idée directrice, un chercheur peut accumuler des observations pendant des années sans jamais rien découvrir, parce qu'il ne sait même pas ce qu'il cherche à voir dans ce qu'il observe.

Bernard résume ce point dans une formule restée célèbre dans l'enseignement de sa méthode :

> « Celui qui ne sait pas ce qu'il cherche ne comprend pas ce qu'il trouve. »

<!-- Note pour relecture humaine : formule très couramment attribuée à Claude Bernard et citée dans les manuels de philosophie à propos de l'Introduction à l'étude de la médecine expérimentale (1865) -- restituée ici à partir de la lecture standard qu'en donnent les manuels, sans prétendre à une citation mot pour mot vérifiée sur une édition de référence précise ; à vérifier avant publication si une citation exacte est requise. -->

**Un exemple resté célèbre de ce mécanisme, dans sa propre pratique.** Bernard raconte, dans son *Introduction*, comment une observation en apparence insignifiante — une anomalie relevée sur des lapins de son laboratoire — ne prend sens, et ne devient une découverte, qu'à partir du moment où il la relie à une hypothèse précise sur l'état nutritionnel des animaux ; c'est cette hypothèse, et elle seule, qui lui indique ensuite quelle expérience mener pour la vérifier ou l'écarter. Sans l'hypothèse formée à l'avance, l'anomalie serait restée une curiosité sans suite, notée puis oubliée.

<!-- Note pour relecture humaine : allusion générale, volontairement non détaillée sur le plan physiologique, à l'épisode dit « des lapins » de l'Introduction à l'étude de la médecine expérimentale -- les détails biochimiques précis ne sont pas affirmés ici afin d'éviter tout risque d'inexactitude ; à enrichir ou vérifier sur le texte de Bernard si un développement plus précis est souhaité. -->

**Ce que ce mécanisme change pour la question de R1 et R2 :** l'expérience n'est donc jamais le point de départ neutre et brut que l'empirisme le plus naïf imagine — un simple regard posé sur le réel, qui livrerait ses faits de lui-même à qui voudrait bien observer attentivement. Elle est toujours déjà orientée par une théorie qui décide ce qui compte comme un fait pertinent. Tu retrouves ici, sous une autre forme, exactement le geste que Bachelard défendait à propos de la connaissance scientifique en général (la-verite, R4) : la connaissance ne lit jamais le réel de façon immédiate et innocente — elle se construit, activement, contre les évidences premières et à partir d'une théorie qui oriente le regard.

#### Applique le mécanisme : comment tester sérieusement la tisane de grand-mère

**Ce que cherche un chercheur formé à la méthode de Bernard, ici, et pourquoi ce geste précis.** Face à la conviction de grand-mère, il ne se contente pas d'attendre encore quarante ans en comptant les cas favorables (R2 a montré que ça ne prouverait toujours rien de plus) : il formule d'abord une hypothèse précise et testable — « la tisane accélère la guérison du rhume, par rapport à l'absence de tout traitement » — puis il conçoit une expérience capable de la mettre à l'épreuve.

- **Étape 1 : isoler la variable.** Il faut comparer deux groupes de personnes enrhumées aussi semblables que possible en tout le reste (âge, état de santé, sévérité du rhume) — l'un recevant la tisane, l'autre non (ou un liquide sans principe actif, pour contrôler l'effet du simple fait de boire quelque chose de chaud). Sans ce groupe de comparaison, impossible de savoir si la guérison observée chez grand-mère vient de la tisane ou du cours naturel du rhume, exactement le doute soulevé en R2.
- **Étape 2 : prédire ce que l'hypothèse implique.** Si la tisane a un effet réel, le groupe qui la reçoit doit guérir significativement plus vite, en moyenne, que le groupe qui ne la reçoit pas. Si les deux groupes guérissent au même rythme, l'hypothèse est affaiblie, sinon réfutée.
- **Étape 3 : observer le résultat, et le laisser trancher.** C'est seulement à ce stade que l'observation intervient — mais une observation guidée du début à la fin par l'hypothèse et par la comparaison qu'elle a rendue nécessaire, et non une observation brute et isolée comme celle de grand-mère.

Ce protocole ne « prouve » toujours rien avec une certitude absolue (R2 le rappelle) — mais il rend l'hypothèse sérieusement **testable**, ce que quarante ans d'observation non guidée, à elle seule, ne permettait jamais de faire.
...
Le protocole de R3 a une structure précise : une hypothèse permet de prédire un résultat ; si ce résultat n'a pas lieu, l'hypothèse est affaiblie ou réfutée ; s'il a lieu, l'hypothèse est seulement confirmée, jamais prouvée avec une certitude définitive (R2). Tu as déjà rencontré, dans la leçon sur la vérité, le philosophe qui a donné à cette structure son nom précis : Popper (la-verite, R7).

#### Rappel du critère, et ce qu'il ajoute ici

Rappelle-toi le critère central : une théorie mérite le nom de scientifique si, et seulement si, elle est **falsifiable** — si elle interdit certains résultats observables possibles, de telle sorte qu'une observation future pourrait, en principe, la contredire. Aucune accumulation de confirmations ne prouve jamais définitivement une théorie ; une seule observation contraire, en revanche, peut la réfuter d'un coup. C'est exactement, formulé en un principe général, ce que le protocole de R3 met en pratique dans un cas particulier : l'hypothèse sur la tisane est construite de telle sorte qu'un résultat précis (l'absence de différence entre les deux groupes) pourrait la réfuter.

**Ce que R3 ajoute au critère de Popper, et qui n'apparaissait pas encore aussi nettement dans la-verite :** Popper explique *pourquoi* la confirmation ne prouve jamais rien (R2, le problème de l'induction) ; Bernard montre *comment*, concrètement, on construit une expérience qui expose réellement une hypothèse au risque d'être réfutée, plutôt que de se contenter d'attendre des confirmations qui arrivent de toute façon (comme le rhume qui guérit tout seul). Le critère de Popper est la logique ; la méthode de Bernard en est la mise en pratique dans un laboratoire.
...
R1 a opposé empirisme et rationalisme comme deux camps rivaux. Mais R3 et R4 ont montré quelque chose que ni l'un ni l'autre, pris séparément, n'explique bien : l'expérience scientifique la plus rigoureuse suppose toujours déjà une idée, une hypothèse, une structure conceptuelle — sans quoi elle ne serait qu'un enregistrement sans direction. Faut-il alors, comme le rationalisme, réduire l'expérience à un rôle secondaire ? Kant (XVIIIe siècle, *Critique de la raison pure*, 1781) refuse ce choix, et propose une troisième voie.

#### Le geste central : deux facultés qui doivent nécessairement collaborer

**Voici la thèse de Kant, et ce qu'elle change par rapport à R1.** La connaissance suppose toujours deux éléments, d'origine différente, dont ni l'un ni l'autre ne suffit seul :

- La **sensibilité** fournit la **matière** de la connaissance : ce qui est donné, reçu passivement des sens — ce que Kant appelle l'**a posteriori**, ce qui vient après, et dépend de, l'expérience particulière. Mais la sensibilité elle-même reçoit ce contenu à travers deux formes universelles qui ne viennent pas de l'expérience mais la rendent possible : l'espace et le temps.
- L'**entendement** fournit la **forme**, la structure conceptuelle qui organise cette matière brute — des concepts comme la causalité, la substance, l'unité — que Kant appelle des concepts **a priori** : universels, nécessaires, indépendants de toute expérience particulière, et pourtant seuls capables de transformer une simple sensation en un objet de connaissance pensable.

**Ce que Kant en tire, dans une formule restée célèbre :**

> « Sans la sensibilité, aucun objet ne nous serait donné ; sans l'entendement, aucun ne serait pensé. Des pensées sans contenu sont vides, des intuitions sans concepts sont aveugles. »

<!-- Note pour relecture humaine : traduction française usuelle (manuels de philosophie) de la formule de la Critique de la raison pure, 1781/1787 (A51/B75) -- rendue en substance à partir de traductions courantes, sans certitude absolue sur le mot-à-mot d'une édition de référence précise ; à vérifier sur une traduction validée avant publication si une citation exacte est requise. -->

**Ce que cette formule règle, précisément, dans la dispute de R1 :** l'empirisme a raison de dire que toute connaissance commence avec l'expérience (rien n'est connu sans que la sensibilité fournisse une matière) — mais il a tort de croire que toute connaissance ne fait que dériver de l'expérience, comme si l'esprit était une simple table vide qui recevrait passivement des impressions. Le rationalisme a raison de dire que certaines structures (l'espace, le temps, la causalité) ne viennent pas de l'expérience et la rendent au contraire possible — mais il a tort d'en conclure qu'on pourrait, par la raison seule, sans jamais faire appel à aucune expérience, connaître le contenu du monde réel.

#### Applique le mécanisme : reviens à la tisane, et à la cause elle-même

Reprends le point de Hume (R2) : la nécessité causale n'est jamais donnée directement par les sens, on ne perçoit qu'une conjonction constante. Kant explique pourquoi grand-mère relie malgré tout, sans effort et sans même y penser, la tisane et la guérison sous l'idée d'une cause : le concept de causalité n'est pas lui-même une impression sensible qu'elle aurait perçue — c'est une forme a priori de son entendement, une structure que son esprit applique spontanément à ce qu'il perçoit, pour organiser une simple succession d'événements (boire, puis guérir) en un lien causal pensable. Ce concept, sans lequel elle ne pourrait même pas formuler sa conviction, ne vient donc ni de la seule expérience (Hume l'a montré : on ne voit jamais la nécessité), ni de la seule raison sans aucun contact avec l'expérience (il faut bien que la sensibilité lui donne la matière — la tisane bue, la guérison observée) : il naît de leur collaboration nécessaire, exactement ce que Kant vient d'établir.
...
L'empirisme (R1, Hume) dirait que sa conviction, comme toute connaissance, prend sa source légitimement dans l'expérience répétée — mais que l'expérience seule, aussi répétée soit-elle, ne suffit jamais à établir une loi universelle avec certitude (R2) : voir mille guérisons après la tisane ne prouve pas plus que voir mille cygnes blancs ne prouvait que tous les cygnes le sont.

Le rationalisme (R1, Descartes) rappellerait qu'aucune accumulation d'observations sensibles, à elle seule, n'a jamais valeur de démonstration rigoureuse : il faudrait un raisonnement capable d'exclure explicitement les autres explications possibles, comme la guérison naturelle du rhume, exactement ce que grand-mère n'a jamais fait.

Claude Bernard (R3) refuserait de trancher sur la seule base de l'observation passive de grand-mère : il faudrait construire une expérience — un groupe avec tisane, un groupe sans — capable de mettre l'hypothèse à l'épreuve, parce qu'une observation qui ne part d'aucune hypothèse précise et d'aucune comparaison ne peut jamais, à elle seule, décider de rien.

Popper (R4, et la-verite R7) ajouterait qu'il faut d'abord reformuler la conviction de grand-mère sous une forme falsifiable — une forme qui interdise un résultat précis — avant même de pouvoir la tester sérieusement ; telle qu'elle l'énonce elle-même, elle n'a jamais couru le moindre risque d'être mise en défaut.

Kant (R5) rappellerait que même la simple perception de grand-mère — « j'ai bu, puis j'ai guéri » — suppose déjà, silencieusement, des formes qui ne viennent pas de la seule expérience (le temps qui ordonne le « puis », la causalité qui relie les deux événements) : sa conviction n'est donc ni une pure lecture de l'expérience brute, ni une pure construction de la raison seule, mais déjà, sans qu'elle le sache, une synthèse des deux.

Et Bachelard, déjà rencontré dans la leçon sur la vérité (la-verite, R4), ferait remarquer que la certitude la plus immédiate — « je l'ai vu, encore et encore, ça ne peut pas être un hasard » — est précisément le genre d'évidence spontanée qu'il faudrait traiter comme un obstacle à interroger, et non comme un point de départ fiable : la connaissance ne se construit jamais en confirmant simplement ce qu'on croyait déjà, mais en rompant avec cette évidence pour la mettre activement à l'épreuve.
...
- **« Une théorie scientifique »** : rappelle-toi la distinction de R4 — une théorie, pour mériter ce nom aux yeux de Popper, doit être falsifiable ; elle propose un énoncé général qui interdit certains résultats observables.
- **« Prouvée »** : le mot suggère une démonstration définitive, close, qui ne pourrait plus jamais être remise en cause — exactement ce que R2 (l'induction) et R4 (Popper) refusent d'accorder à quelque théorie scientifique que ce soit.
- **« Par l'expérience »** : au sens de Bernard (R3), l'expérience n'est jamais une simple observation passive — elle est déjà construite, orientée par une hypothèse ; le sujet demande donc si ce type d'expérience construite, actif, peut suffire à établir une preuve définitive.
...
Ici, la tension est celle construite tout au long de la leçon : l'expérience semble bien être le juge ultime d'une théorie scientifique — c'est elle qui décide, en dernier ressort, si une hypothèse tient ou s'effondre (R3, R4). Mais R2 a montré qu'aucune accumulation d'observations confirmantes ne peut jamais logiquement prouver une loi universelle, et R4 (Popper) que l'expérience ne peut, structurellement, que réfuter, jamais définitivement confirmer. Comment l'expérience peut-elle alors être le juge d'une théorie sans jamais pouvoir la prouver ?
...
Développe l'idée intuitive, celle de grand-mère généralisée à la science : plus une théorie est confirmée par l'expérience, plus elle mérite d'être tenue pour vraie ; une théorie qui prédit correctement, encore et encore, semble avoir fait ses preuves. Mobilise la méthode de Bernard (R3) comme ce qui rend cette confrontation à l'expérience rigoureuse, et non arbitraire.

**II. Antithèse — Aucune accumulation de confirmations ne prouve jamais définitivement une théorie.**
Mobilise R2 (le problème de l'induction chez Hume : voir mille cygnes blancs ne prouve pas que tous les cygnes le sont) et R4 (Popper : une théorie n'est jamais que corroborée, jamais prouvée ; elle ne peut être que réfutée). Mobilise aussi l'exemple du modèle de Ptolémée (la-verite, R3 et R7) : cohérent et prédictif pendant plus de mille ans, et pourtant faux — la confirmation prolongée n'a jamais été une preuve.

**III. Dépassement — Renoncer à la preuve absolue n'oblige pas à renoncer à toute exigence de rigueur.**
Reprends R4 (le fallibilisme popperien : une théorie non-encore-réfutée, sérieusement mise à l'épreuve par une méthode comme celle de Bernard, R3, mérite une confiance réelle même sans preuve définitive) et R5 (Kant : la connaissance scientifique articule nécessairement une structure conceptuelle a priori et une matière donnée a posteriori — ni la théorie seule, ni l'expérience seule, ne suffit). Ajoute R6 : cette absence de preuve définitive ne rend pas toutes les théories équivalentes — une théorie sérieusement exposée au risque de la réfutation et une conviction qui n'a jamais couru ce risque (comme celle de grand-mère) ne sont pas logées à la même enseigne.
...
> Une grand-mère certaine, après quarante ans sans exception, que sa tisane guérit le rhume, et un chercheur qui refuse de la croire sur cette seule base : les deux s'accordent pourtant sur un point — c'est l'expérience, en dernier ressort, qui doit trancher si une théorie tient ou s'effondre. Une théorie scientifique semble ainsi tirer sa valeur de sa confrontation répétée à l'expérience : plus elle est confirmée, plus elle paraît méritante d'être tenue pour prouvée. Mais Hume a montré qu'aucun nombre d'observations confirmantes, même immense, ne peut jamais logiquement garantir qu'une loi générale vaut aussi pour les cas qu'on n'a jamais observés — voir mille cygnes blancs ne prouve pas que tous le sont ; et Popper en a tiré un critère radical : une théorie scientifique ne peut, par l'expérience, qu'être réfutée, jamais définitivement prouvée. Si l'expérience est pourtant le seul juge légitime d'une théorie, comment expliquer qu'elle ne puisse jamais l'établir comme prouvée avec certitude ? Faut-il en conclure qu'aucune théorie scientifique n'est jamais fondée, ou existe-t-il une façon, pour la théorie et l'expérience, de s'articuler qui ne suppose pas cette preuve absolue ? On examinera d'abord ce que l'expérience semble capable de prouver, avant d'en mesurer la limite logique, pour dégager enfin ce que suppose, malgré tout, une théorie scientifique rigoureuse.
...
**Pourquoi ce paragraphe est construit ainsi :** il ne se contente pas d'affirmer la thèse intuitive — il la fait *fonctionner* sur la méthode précise de Bernard (l'hypothèse, la déduction d'une conséquence observable, l'expérience comparative), comme la leçon l'a construite. Remarque la dernière phrase : elle prépare déjà, sans le dire explicitement, la question qui ouvrira la partie II — que devient cette confiance apparemment bien fondée dans la mécanique de Newton, si l'on se souvient (la-verite, R7) qu'elle a fini par se révéler seulement approximativement valable ?

#### À toi de continuer

Rédige maintenant, à ton tour :

1. Un paragraphe de la partie II (l'antithèse), en t'appuyant SOIT sur le problème de l'induction chez Hume (R2), SOIT sur le critère de falsifiabilité de Popper (R4) — pas les deux à la fois dans un seul paragraphe.
2. Un paragraphe de la partie III (le dépassement), en croisant le fallibilisme de Popper (R4) et la synthèse kantienne de la sensibilité et de l'entendement (R5), pour montrer en quoi renoncer à la preuve absolue ne dispense jamais d'exiger une théorie rigoureusement mise à l'épreuve.
