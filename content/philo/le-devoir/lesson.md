...
Tu es en plein contrôle. Un exercice te résiste complètement. Ta voisine, elle, a fini : sa copie est là, à moitié visible, et le surveillant vient de sortir régler un problème dans le couloir. Personne ne te regarde. Personne ne saura jamais, quoi que tu fasses dans les trente secondes qui viennent.

**Que fais-tu — et surtout : pourquoi ?**
...
Mais si tu prends la seconde réponse au sérieux, une autre question surgit aussitôt : ce « non » qui persiste même sans surveillant, d'où vient-il, au juste ? Es-tu sûr que ce n'est pas, toi aussi, une forme de peur — la peur d'un jugement plus diffus (ta propre conscience, l'idée de ce que tu penserais de toi-même après coup, l'éducation reçue) — donc, en un sens, encore une contrainte, seulement plus discrète et intériorisée qu'un surveillant en chair et en os ? Comment être sûr qu'il existe un devoir véritable, distinct de la simple peur d'un gendarme qu'on aurait fini par installer dans sa propre tête ?

C'est exactement ce problème — comment penser un devoir qui ne se réduise ni à la peur d'une sanction externe, ni à une simple habitude de conscience qu'on aurait avalée sans l'examiner — que cette leçon va construire, pièce par pièce. On reviendra à cette salle d'examen à la fin.
...
**Le devoir comme contrainte extérieure.** Dans ce sens, je « dois » faire quelque chose parce qu'une autorité extérieure à moi — la loi, le règlement intérieur, un surveillant, une sanction possible — me l'impose et me punira si je désobéis. Ce devoir-là se mesure à la surveillance : plus le risque d'être vu et puni est élevé, plus il « pèse » ; s'il disparaît, comme le surveillant qui sort, l'obligation, prise dans ce seul sens, disparaît avec lui.

**Le devoir comme obligation morale.** Dans ce second sens, je « dois » faire quelque chose parce que je juge, moi-même, que c'est ce qu'il faut faire — indépendamment de toute sanction, de tout regard extérieur, de toute conséquence pour moi. Ce devoir-là ne dépend pas de la présence d'un surveillant : il vaudrait exactement autant seul sur une île déserte que dans une salle bondée.
...
Réduire tout devoir à la contrainte extérieure ne rend pas compte de ce qui se passe réellement dans la salle d'examen sans surveillant : quelque chose continue d'agir quand le risque a disparu, et ce quelque chose mérite d'être expliqué, pas simplement nié.

Mais affirmer un devoir moral pur, détaché de toute contrainte, sans jamais interroger d'où il vient, laisse une question ouverte et gênante : comment distinguer un devoir moral authentique d'une simple habitude sociale profondément intériorisée — la voix de l'éducation reçue, qu'on prendrait à tort pour la voix universelle de la morale ? Toutes les sociétés, à toutes les époques, n'ont pas jugé « devoir » les mêmes choses ; certaines ont même fait un devoir de pratiques qu'on juge aujourd'hui immorales. Le simple sentiment intérieur d'être obligé ne suffit donc pas, à lui seul, à garantir qu'on tient un devoir moral véritable plutôt qu'un conditionnement.

**C'est cette tension qui constitue le problème philosophique du devoir** — et non un simple choix entre « ce n'est que la loi » et « c'est ma conscience qui parle ». La position étudiée dans la rubrique suivante ne tranche pas ce problème en piochant un camp : elle propose un critère précis pour reconnaître un devoir moral authentique, distinct à la fois de la contrainte externe et du simple sentiment.
...
Ce commerçant peut agir ainsi pour deux raisons très différentes, qui produisent exactement la même action visible.

- Il peut ne pas tromper ses clients **par intérêt** : une réputation d'honnêteté fait revenir la clientèle, donc l'honnêteté est rentable à long terme. Dans ce cas, il agit **conformément au devoir** — son action correspond à ce que le devoir exige — mais son mobile réel est l'intérêt, pas le devoir lui-même.
- Il peut aussi ne pas tromper ses clients **par devoir** : par pur respect pour l'exigence morale de ne pas mentir, indépendamment de toute conséquence sur ses affaires — au point qu'il agirait exactement pareil si l'honnêteté lui coûtait sa clientèle.

**Voici le point le plus important, et le plus souvent manqué :** pour Kant, seule la seconde action a une valeur morale. La première, si elle ne dépendait que de l'intérêt, disparaîtrait le jour où mentir deviendrait plus rentable qu'être honnête — elle ne tient qu'à un calcul, pas à un principe. Le devoir véritable ne se reconnaît pas à ce que l'action produit en apparence, mais à ce qui continuerait à la produire même quand plus aucun intérêt, aucune inclination, aucune récompense ne serait là pour la soutenir.
...
Sa première formulation est une règle de cohérence rationnelle :

> « Agis uniquement d'après la maxime qui fasse que tu puisses vouloir en même temps qu'elle devienne une loi universelle. »

**Le mécanisme du test, expliqué :** avant d'agir, formule la règle générale (la *maxime*) que ton action suivrait, puis demande-toi : pourrais-je vouloir que TOUT LE MONDE, dans une situation semblable, suive cette même règle ? Si la réponse s'effondre — si la règle, généralisée, se détruit elle-même — alors l'action est interdite.
...
Cette perspective met en lumière une faille réelle du formalisme kantien poussé à son terme. Kant lui-même, dans un texte tardif consacré à la question du mensonge, soutient qu'il ne faut jamais mentir, même pour protéger un innocent d'un meurtrier qui le cherche et te demande où il se cache : mentir, même dans ce cas, violerait le devoir absolu de dire la vérité. De nombreux lecteurs de Kant — pas seulement les utilitaristes — ont jugé cette conséquence intenable : un devoir si rigide qu'il interdirait de mentir pour sauver une vie semble sacrifier ce que la morale est censée protéger (la vie, le bien d'autrui) à la seule cohérence formelle d'une règle. L'utilitariste répondrait sans détour : c'est justement parce qu'on ignore les conséquences qu'on peut arriver à une conclusion aussi choquante ; juger l'action à son résultat réel évite cette impasse.
...
Bergson distingue deux visages de la morale. La **morale close** est celle de l'obligation ordinaire : elle vient de la pression du groupe social, de l'habitude, de l'éducation — un peu comme les cellules d'un même corps se coordonnent instinctivement pour que l'organisme tienne. Cette morale assure la cohésion d'un groupe fermé sur lui-même (une famille, une nation), mais elle reste, par nature, une pression reçue de l'extérieur, intériorisée au point de sembler venir de soi.

La **morale ouverte**, à l'inverse, ne procède pas d'une pression mais d'un **appel** : elle apparaît chez certaines figures exceptionnelles — Bergson pense aux grands mystiques, aux figures morales exemplaires de l'humanité — qui n'obéissent à aucune règle imposée, mais agissent portées par un élan de générosité tourné vers l'humanité tout entière, et non plus seulement vers leur propre groupe. Bergson relie cet élan à l'**élan vital** qui, selon lui, traverse toute l'évolution du vivant (*L'Évolution créatrice*, 1907) : la même poussée créatrice qui invente sans cesse de nouvelles formes de vie se prolonge, chez l'être humain, en une capacité à dépasser l'obligation reçue pour créer, librement, une exigence morale neuve.

**Ce que cette distinction change pour notre problème :** Bergson ne dit pas que la morale de l'obligation (proche, par bien des aspects, du devoir kantien) est fausse ou inutile — elle reste le socle nécessaire de toute vie sociale organisée. Mais il montre qu'elle ne suffit pas à tout expliquer : le dévouement d'une figure comme celui de personnalités qui ont consacré leur vie aux plus démunis sans qu'aucune règle ne le leur impose ne s'explique pas par une simple obligation reçue et respectée — c'est un élan, pas une contrainte, fût-elle intériorisée. Réduire tout le champ moral à des devoirs obligatoires, c'est manquer cette part de la vie morale qui relève de l'inspiration plutôt que de la règle.
...
Ici, la tension est celle construite dans la leçon : si agir par devoir ne suffisait pas, comment expliquer que Kant fasse de la seule bonne volonté le bien absolu, indépendant de tout le reste ? Mais si agir par devoir suffisait entièrement, comment expliquer les cas où un devoir appliqué à la lettre (ne jamais mentir, même au meurtrier) produit un résultat que presque tout le monde juge moralement inacceptable, ou les cas où l'action la plus admirable ne vient d'aucune règle mais d'un élan qui dépasse l'obligation ?
...
> Un élève qui ne triche jamais, même seul face à une copie qui traîne et à aucun risque d'être vu, semble incarner ce qu'on appelle bien agir par excellence : il obéit à son devoir sans que rien ne l'y contraigne. Faut-il en conclure qu'agir par devoir — accomplir ce que l'on juge moralement exigé, indépendamment de tout intérêt et de toute peur de la sanction — suffit à garantir qu'on agit bien ? L'intuition kantienne y répond par l'affirmative : seule une action accomplie par pur respect de l'exigence morale, et non par calcul ou inclination, mérite d'être appelée bonne sans restriction. Mais cette exigence, appliquée à la lettre, conduit à des conclusions troublantes : faudrait-il, par devoir de dire la vérité, révéler à un meurtrier où se cache sa victime ? Et l'existence de personnes qui se dévouent aux autres sans qu'aucun devoir ne le leur impose, portées par un élan plutôt que par une règle, ne montre-t-elle pas que le seul vocabulaire du devoir ne suffit pas à décrire tout le bien agir possible ? Si le seul respect du devoir suffisait à garantir qu'on agit bien, comment expliquer ces cas où il produit, ou laisse de côté, ce que presque tout le monde jugerait pourtant essentiel — et faut-il alors autre chose, en plus du devoir, pour bien agir ? On examinera d'abord ce que le devoir kantien apporte de proprement irremplaçable, avant d'en mesurer les limites, pour dégager enfin ce qu'il faut y ajouter, sur le fond d'une liberté qu'il suppose, pour bien agir pleinement.
